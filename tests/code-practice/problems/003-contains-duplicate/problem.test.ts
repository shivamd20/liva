/**
 * Contains Duplicate Problem Tests
 * 
 * Comprehensive E2E tests for the Contains Duplicate problem.
 */

import { describe, it, expect, beforeAll } from 'vitest';
import { starterCode as STARTER_CODE, referenceSolution as REFERENCE_SOLUTION, sortingSolution as SORTING_SOLUTION } from '../../../../problems/003-contains-duplicate/java';
...
const PROBLEM_ID = 'contains-duplicate';
...
describe('Problem 003: Contains Duplicate', () => {
    beforeAll(async () => {
    ...
    describe('Starter Code', () => {
        it('should be runnable and return WA (always returns false)', async () => {
    ...
    describe('Accepted (AC)', () => {
        it('should return AC for HashSet solution', async () => {
